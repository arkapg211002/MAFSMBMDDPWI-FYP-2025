...
- **Ensemble Model:** Leveraged high accuracy of Logistic regression, Naive Bayes, SVM, LSTM and XGBoost to create an ensemble model with accuracy of 97.3% (Used this model in the web application).
