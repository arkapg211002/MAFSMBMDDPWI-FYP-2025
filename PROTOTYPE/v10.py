...
@st.cache_resource
def load_meta_learner_xgb():
    return joblib.load('meta_learner_xgb.pkl')
...
meta_learner_xgb = load_meta_learner_xgb()
...
def classify_text(text):
    ...
    final_prediction_proba = meta_learner_xgb.predict_proba(stacked_features)
    final_prediction = meta_learner_xgb.predict(stacked_features)
