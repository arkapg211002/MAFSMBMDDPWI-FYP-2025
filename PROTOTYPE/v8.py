    ...
    try:
        ...
        for image_url in images:
            try:
                ...
                if dominant_emotion:
                    st.write(f"Dominant Emotion Detected: {dominant_emotion}")
                    all_emotions[dominant_emotion] += 1
                else:
                    st.write("No faces detected or error in emotion analysis.")
            except Exception as e:
        ...
        if all_emotions:
            ...
            st.write(f"Most Frequent Emotion Across All Images or no Images(Default): {dominant_emotion}")
            ...
            st.write("No images processed or error in emotion analysis.")
...
def classify_text(text):
    ...
    st.write(f"The most likely mental health concern from all the text obtained is: {top_issue} with a probability of {top_probability:.2%}")
