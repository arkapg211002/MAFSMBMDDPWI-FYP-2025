...
@st.cache_resource
def load_meta_learner_lr():
    return joblib.load('meta_learner_lr.pkl')
...
meta_learner_lr = load_meta_learner_lr()
...
def classify_text(text):
    ...
    final_prediction_proba = meta_learner_lr.predict_proba(stacked_features)
    final_prediction = meta_learner_lr.predict(stacked_features)
