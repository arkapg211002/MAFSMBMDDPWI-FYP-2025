...
\begin{center}
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        ...
        {\makebox[2.5em][r]{\textbf{99.12}}}%
        {\makebox[2.5em][l]{\textbf{96.24}}} \\ \hline
    \end{tabular}
    } % End of resizebox
    \\[1em]
    \textbf{Note:} The final ensemble models from two different architectures achieved accuracies of \textbf{96.24\%} and \textbf{99.12\%} respectively.
\end{center}
