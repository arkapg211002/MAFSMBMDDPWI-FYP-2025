...
\begin{figure}[h!]  
    \centering
    \includegraphics[width=0.7\textwidth]{Images/HP SVM CM.png}  
...
\begin{figure}[h!]  
    \centering
    \includegraphics[width=0.7\textwidth]{Images/HP SVM ROC.png}  
...
\begin{figure}[h!]  
    \centering
    \includegraphics[width=0.7\textwidth]{Images/HP NB CM.png}  
...
\begin{figure}[h!]  
    \centering
    \includegraphics[width=0.7\textwidth]{Images/HP NB ROC.png}  
...
\begin{center}
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        \textbf{Accuracy}   & \multicolumn{4}{|c|}{\textbf{97.84\%}} \\ \hline
