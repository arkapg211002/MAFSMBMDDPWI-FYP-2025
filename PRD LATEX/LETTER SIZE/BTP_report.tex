...
\captionsetup{
  labelfont=bf,    % bold “Fig. 7.1”
  labelsep=quad   % drop the colon, leave one space
}

% 1) tie figure numbering to section
\usepackage{chngcntr}
\counterwithin{figure}{section}

% 2) switch “Figure” → “Fig.” and format as <sec>.<fig>
...
\definecolor{lightestgray}{gray}{0.93} 
